...
public class FeedbackResourceIT {
    ...
    public void createFeedback() throws Exception {
        ...
        assertThat(testFeedback.getDescricao()).isEqualTo(DEFAULT_DESCRICAO);
        assertThat(testFeedback.getAcao()).isEqualTo(DEFAULT_ACAO);
    }
    ...
    public void updateFeedback() throws Exception {
        ...
        Feedback testFeedback = feedbackList.get(feedbackList.size() - 1);
        assertThat(testFeedback.getDescricao()).isEqualTo(UPDATED_DESCRICAO);
        assertThat(testFeedback.getAcao()).isEqualTo(UPDATED_ACAO);
    }
